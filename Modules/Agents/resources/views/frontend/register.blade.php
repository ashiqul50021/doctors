...
@section('title', 'Agent Registration - ' . ($siteSettings['site_name'] ?? 'abcsheba'))
    ...
    <div class="split-layout">
        <div class="split-right">
            <div class="split-form-container">
                ...
                <h3 class="form-title">Join as an Agent</h3>
                <p class="form-subtitle">Fill in the fields below to register your agent account</p>
                ...
                <form action="{{ route('agent.register.submit') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="split-label">Email Address</label>
                    ...
                    <div class="d-grid mb-4">
                        <button class="btn split-btn" type="submit">Submit Application</button>
                    </div>

                    <div class="text-center mt-4">
                        <span style="font-size: 0.875rem; color: #4b5563;">Already have an agent account? <a
                                href="{{ route('agent.login') }}"
                                style="color: #345cce; font-weight: 600; text-decoration: none;">Sign In here</a></span>
                    </div>
                </form>
            </div>
        </div>
