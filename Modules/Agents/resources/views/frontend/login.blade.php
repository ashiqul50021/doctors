    ...
    <div class="split-layout">
        <div class="split-right">
            <div class="split-form-container">
                ...
                <h3 class="form-title">Agent Portal</h3>
                <p class="form-subtitle">Enter your details to sign in as a sales/booking agent</p>
                ...
                <form action="{{ route('agent.login.submit') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" class="form-control split-input" name="email" required
                            value="{{ old('email') }}" placeholder="agent@example.com">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="split-input-group">
                            ...
                            <i class="far fa-eye split-input-icon" onclick="togglePasswordVisibility()"></i>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <span style="font-size: 0.875rem; color: #4b5563;">Don't have an agent account? <a
                                href="{{ route('agent.register') }}"
                                style="color: #345cce; font-weight: 600; text-decoration: none;">Register here</a></span>
                    </div>
                </form>
            </div>
        </div>
