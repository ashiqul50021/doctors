                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div id="product-benefits-container">
                                                ...
                                                @endphp
                                                @foreach($defaultCreateBenefits as $idx => $benefitText)
                                                    <div class="benefit-item d-flex align-items-start gap-2 mb-2">
                                                        <textarea name="landing_settings[product_benefits][]" class="form-control form-control-sm" rows="2" placeholder="সুবিধার বিবরণ এখানে লিখুন">{{ old('landing_settings.product_benefits.' . $idx, $benefitText) }}</textarea>
