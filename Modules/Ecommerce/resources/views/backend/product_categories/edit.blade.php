...
@section('title', 'Edit Category - abcsheba Admin')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('ecommerce.admin.product-categories.update', $productCategory->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <select name="parent_id" class="form-control">
                                    ...
                                    @foreach($parentCategories as $parent)
                                        ...
                                        @foreach($parent->children as $child)
                                            <option value="{{ $child->id }}" {{ old('parent_id', $productCategory->parent_id) == $child->id ? 'selected' : '' }}>
                                                &nbsp;&nbsp;&mdash;&nbsp;{{ $child->name }}
                                            </option>
                                        @endforeach
                                    @endforeach
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $productCategory->is_active) ? 'checked' : '' }}>
