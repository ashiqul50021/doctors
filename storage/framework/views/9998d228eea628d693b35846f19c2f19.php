                            ...
                            <tbody>
                                <tr>
                                    <td class="table-avatar">
                                        <a href="<?php echo e(route('doctors.admin.doctors.index')); ?>" class="avatar avatar-sm me-2">
                                            <img class="avatar-img rounded-circle"
                                                src="<?php echo e(asset('assets/img/doctors/doctor-thumb-01.jpg')); ?>"
                                                alt="User Image">
                                        </a>
                                        <a href="<?php echo e(route('doctors.admin.doctors.index')); ?>">Dr. Ruby Perrin</a>
                                    </td>
                                    <td>Dental</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="table-avatar">
                                        ...
                                        <a href="<?php echo e(route('doctors.admin.doctors.index')); ?>">Dr. Darren Elder</a>
                                    </td>
                                    <td>Dental</td>
                                    <td>
                                        <a href="<?php echo e(route('admin.patients')); ?>" class="avatar avatar-sm me-2">
                                ...
                                <tr>
                                    <td class="table-avatar">
                                        ...
                                        <a href="<?php echo e(route('doctors.admin.doctors.index')); ?>">Dr. Deborah Angel</a>
                                    </td>
                                    <td>Cardiology</td>
                                    <td>
                                        <a href="<?php echo e(route('admin.patients')); ?>" class="avatar avatar-sm me-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u190556289/domains/abcseba.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>