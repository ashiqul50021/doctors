    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="<?php echo e(request()->routeIs('admin.specialities.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.specialities.index')); ?>"><i class="fe fe-users"></i>
                        <span>Specialities</span></a>
                </li>
                <li class="<?php echo e(request()->routeIs('admin.doctors.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.doctors.index')); ?>"><i class="fe fe-user-plus"></i>
                        <span>Doctors</span></a>
                </li>
                ...
                <li class="<?php echo e(request()->routeIs('admin.product-categories.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.product-categories.index')); ?>"><i class="fe fe-layout"></i> <span>Product
                            Categories</span></a>
                </li>
                <li class="<?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.products.index')); ?>"><i class="fe fe-shopping-cart"></i>
...
<!-- /Sidebar --><?php /**PATH /home/ashiquli/doctors.ashiqulislamrasel.com/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>