<?php $__env->startSection('title', 'Checkout - abcsheba.com'); ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-2">
                                            <input type="text" name="name" class="form-control" id="name"
                                                placeholder="John Doe" value="<?php echo e(old('name', Auth::user()->name ?? '')); ?>"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-2">
                                            <input type="text" name="phone" class="form-control" id="phone"
                                                placeholder="+8801..."
                                                value="<?php echo e(old('phone', Auth::user()->patient->phone ?? '')); ?>" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating mb-2">
                                            <textarea name="address" class="form-control" id="address" placeholder="Address"
                                                style="height: 100px"
                                                required><?php echo e(old('address', Auth::user()->patient->address ?? '')); ?></textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea name="notes" class="form-control" id="notes" placeholder="Notes"
                                                style="height: 80px"><?php echo e(old('notes')); ?></textarea>
                            ...
                            <div class="card-body p-4">
                                <div class="form-check p-3 border rounded mb-3 shipping-option selected"
                                    ...
                                    <label class="form-check-label d-flex justify-content-between w-100" for="inside_dhaka">
                                        ...
                                        <span
                                            class="fw-bold text-dark">৳<?php echo e($ecommerceSettings['shipping_inside_dhaka'] ?? 60); ?></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-check p-3 border rounded shipping-option"
                                    ...
                                    <label class="form-check-label d-flex justify-content-between w-100"
                                        ...
                                        <span
                                            class="fw-bold text-dark">৳<?php echo e($ecommerceSettings['shipping_outside_dhaka'] ?? 120); ?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e($item['image'] ? asset($item['image']) : asset('assets/img/products/product-1.jpg')); ?>"
                                                alt="<?php echo e($item['name']); ?>" class="me-2"
                                                style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;">
                                            <div>
                                                <small class="fw-bold"><?php echo e(Str::limit($item['name'], 20)); ?></small>
                                                <div class="qty-container mt-1">
                                                    <button type="button" class="qty-btn btn-minus"
                                                        data-id="<?php echo e($productId); ?>"><i class="fas fa-minus"></i></button>
                                                    <input type="number" class="qty-input" value="<?php echo e($item['quantity']); ?>"
                                                        min="1" readonly>
                                                    <button type="button" class="qty-btn btn-plus" data-id="<?php echo e($productId); ?>"><i
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <button type="button" class="btn btn-sm text-danger ms-2"
                                                onclick="removeFromCart(<?php echo e($productId); ?>)" title="Remove">
                                ...
                                <div class="d-flex justify-content-between mb-4 border-top pt-3">
                                    ...
                                    <span class="h4 mb-0 text-primary fw-bold"
                                        id="grand_total">৳<?php echo e(number_format($total, 2)); ?></span>
                                </div>
                                ...
                                <input type="hidden" name="total_amount" id="total_amount_input" value="<?php echo e($total); ?>">

                                <button type="submit" class="btn btn-primary w-100 btn-sm py-2">
                                    <i class="fas fa-check-circle me-2"></i>Place Order
                                </button>
                                <a href="<?php echo e(route('cart')); ?>" class="btn btn-outline-secondary w-100 mt-3">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const shippingInside = <?php echo e($ecommerceSettings['shipping_inside_dhaka'] ?? 60); ?>;
        const shippingOutside = <?php echo e($ecommerceSettings['shipping_outside_dhaka'] ?? 120); ?>;
        ...
        function applyCoupon() {
            ...
            $.ajax({
                url: '<?php echo e(route("cart.coupon")); ?>',
                method: 'POST',
                data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ashiquli/doctors.ashiqulislamrasel.com/resources/views/frontend/product-checkout.blade.php ENDPATH**/ ?>