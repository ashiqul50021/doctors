<div class="bottom-nav-container d-md-none">
    <div class="bottom-nav-menu">
        ...
        <a href="<?php echo e(route('search')); ?>"
            class="nav-item <?php echo e(Route::is('search') || Route::is('doctor.profile') ? 'active' : ''); ?>">
            <div class="nav-icon-container">
...
</div><?php /**PATH /home/ashiquli/doctors.ashiqulislamrasel.com/resources/views/layouts/partials/bottom-nav.blade.php ENDPATH**/ ?>