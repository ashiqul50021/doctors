...
<div class="header">
    ...
    <div class="header-left">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo">
            <img src="<?php echo e(!empty($siteSettings['logo']) ? asset($siteSettings['logo']) : asset('backend/img/logo.png')); ?>"
                alt="Logo">
        </a>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-small">
            <img src="<?php echo e(!empty($siteSettings['favicon']) ? asset($siteSettings['favicon']) : asset('backend/img/logo-small.png')); ?>"
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
                                    <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image"
                                            src="<?php echo e(asset('assets/img/patients/patient1.jpg')); ?>">
                                    </span>
                                    <div class="media-body">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media">
                                    <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image"
                                            src="<?php echo e(asset('assets/img/patients/patient2.jpg')); ?>">
                                    </span>
                                    <div class="media-body">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img"><img class="rounded-circle"
                        src="<?php echo e(asset('backend/img/profiles/avatar-01.jpg')); ?>" width="31" alt="<?php echo e(Auth::user()->name ?? 'Admin'); ?>"></span>
            </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="<?php echo e(asset('backend/img/profiles/avatar-01.jpg')); ?>" alt="User Image"
                            class="avatar-img rounded-circle">
                    </div>
                    <div class="user-text">
                        <h6><?php echo e(Auth::user()->name ?? 'Admin'); ?></h6>
                        <p class="text-muted mb-0"><?php echo e(ucfirst(Auth::user()->role ?? 'administrator')); ?></p>
                    </div>
                </div>
                <a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>">My Profile</a>
                <a class="dropdown-item" href="<?php echo e(route('admin.site-settings.index')); ?>">Settings</a>
...
<!-- /Header -->
<?php /**PATH /home/u190556289/domains/abcseba.com/public_html/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>