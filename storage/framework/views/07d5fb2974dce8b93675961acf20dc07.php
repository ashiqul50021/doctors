...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
                    ...
                    <div class="hero-slide-item">
                        <div class="hero-main-wrapper">
                            <div class="hero-content-left">
                                ...
                                <a href="<?php echo e(route('search')); ?>" class="btn-hero-cta">
            ...
            <div class="hero-search-section">
                ...
                <div class="hero-search-bar">
                    <form action="<?php echo e(route('search')); ?>" class="hero-search-form" id="filterSearchForm">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                                ...
                                <div class="product-card-modern">
                                    ...
                                    <div class="product-image-container">
                                        <a href="<?php echo e(route('products.show', $product->id)); ?>">
                                            ...
                                            ?>
                                            <img src="<?php echo e($image ? asset($image) : asset('assets/img/products/product.jpg')); ?>"
                    ...
                    <div class="text-center mt-4">
                        <a href="<?php echo e(route('products')); ?>" class="btn-view-all-arrow">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="doctor-filter-card">
                        ...
                        <div class="filter-section">
                            ...
                            <div class="category-list">
                                ...
                                <?php $__currentLoopData = $searchSpecialities->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speciality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="category-item">
                ...
                <div class="col-lg-9 col-md-8">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 mb-4 doctor-grid-item">
                                <div class="doctor-card-new">
                                    <div class="doctor-img-wrapper">
                                        <a href="<?php echo e(route('doctor.profile', $doctor->id)); ?>">
                                    ...
                                    <div class="doctor-info">
                                        ...
                                        <h4 class="doctor-name">
                                            <a href="<?php echo e(route('doctor.profile', $doctor->id)); ?>">Dr.
                                        ...
                                        <div class="doctor-buttons">
                                            <a href="<?php echo e(route('doctor.profile', $doctor->id)); ?>" class="btn-view-details">
                    ...
                    <!-- View All Button -->
                    <div class="text-center mt-4">
                        <a href="<?php echo e(route('search')); ?>" class="btn-view-all-arrow">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="health-package-card">
                        ...
                        <a href="<?php echo e(route('products')); ?>" class="btn-package">
                    ...
                    <div class="course-card">
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-footer">
                                ...
                                <a href="<?php echo e(route('products')); ?>" class="btn-enroll">Enroll <i
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="video-promo-content">
                        ...
                        <a href="<?php echo e(route('search')); ?>" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="section-cta">
        ...
        <div class="container text-center position-relative z-index-1">
            ...
            <a href="<?php echo e(route('search')); ?>" class="btn btn-light cta-btn">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ashiquli/doctors.ashiqulislamrasel.com/resources/views/frontend/home.blade.php ENDPATH**/ ?>