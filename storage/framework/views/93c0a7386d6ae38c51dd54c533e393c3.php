    ...
    <div class="card-body p-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-auto text-center mb-3 mb-md-0 position-relative">
                <a href="<?php echo e($profileLink); ?>" class="d-inline-block position-relative">
                    <img src="<?php echo e($image); ?>" class="img-fluid rounded-circle" alt="<?php echo e($name); ?>"
            ...
            <div class="col-md pl-md-4">
                <h4 class="doc-name mb-1">
                    <a href="<?php echo e($profileLink); ?>"
                        style="color: #272b41; font-weight: 700; font-size: 1.25rem; text-decoration: none;"><?php echo e($name); ?></a>
                </h4>
                <p class="doc-speciality mb-3" style="font-size: 0.9rem; color: #757575;"><?php echo e($qualification); ?></p>
                ...
                <div class="d-flex flex-wrap gap-2 mb-3" style="gap: 10px;">
                    <span class="badge badge-pill"
                        ...
                        <img src="<?php echo e($departmentIcon); ?>" alt=""
                    ...
                    <span class="badge badge-pill"
                        ...
                        <i class="fas fa-briefcase" style="margin-right: 4px;"></i> <?php echo e($experience ?? '5+'); ?> Years Exp
                    </span>
                    <span class="badge badge-pill"
                        style="background: #f0f2f5; color: #6c757d; padding: 8px 12px; font-weight: 500;">
                        <i class="fas fa-map-marker-alt" style="margin-right: 4px;"></i> <?php echo e($location); ?>
            ...
            <div class="col-md-auto text-center text-md-right mt-3 mt-md-0 border-left-md pl-md-4"
                ...
                <div class="price-box mb-2">
                    <span style="font-size: 1.25rem; font-weight: 700; color: #111827;">
                        <?php if($price == 'Free'): ?> Free <?php else: ?> ৳<?php echo e(str_replace(['$', 'Free'], '', $price)); ?> <?php endif; ?>
                    </span>
                </div>
                ...
                <div class="rating mb-3">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <i class="fas fa-star"
                            style="color: <?php echo e($i <= $rating ? '#f4c150' : '#dedfe0'); ?>; font-size: 12px;"></i>
                    <?php endfor; ?>
                    <span class="d-block mt-1"
                        style="font-size: 0.85rem; font-weight: 600; color: #272b41;"><?php echo e($thumbsUp); ?> Positive</span>
                </div>

                <div class="actions d-flex flex-column gap-2" style="gap: 10px; min-width: 160px;">
                    <a href="<?php echo e($profileLink); ?>" class="btn btn-outline-primary btn-sm btn-block"
                        style="border-radius: 50px; font-weight: 600; padding: 8px 20px;">View Profile</a>
                    <a href="<?php echo e($bookingLink); ?>" class="btn btn-primary btn-sm btn-block"
...
</div><?php /**PATH /home/ashiquli/doctors.ashiqulislamrasel.com/resources/views/components/search-doctor-card.blade.php ENDPATH**/ ?>