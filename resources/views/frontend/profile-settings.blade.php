                            ...
                            <div class="row form-row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
